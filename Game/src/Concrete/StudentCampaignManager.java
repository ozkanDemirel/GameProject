...
public class StudentCampaignManager implements CampaignService{
	...
	public StudentCampaignManager(Logger[] loggers,Sale sale) {
	...
	public void sale(Gamer gamer ) {
		...
		System.out.println("Öðrenci Ýndirimi Uygulanýyor");
